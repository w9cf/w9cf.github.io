...
*/
   ...
   private void autoTune() {
      tinfo.setText("");
      at.tune(kc1.getValue(),kl.getValue(),kc2.getValue(),
         c1max,elmax,c2max,qc1,qel,qc2,f,zlr,zli);
      if (at.isTuned()) {
         setComponents(at.getCin(),at.getL(),at.getCout());
      } else {
   ...
   public String getAppletInfo() {
      return "T-Network Tuner Simulator, version 0.04" +
        " Copyright 1999-2003, Kevin E. Schmidt";
   }
...
class MyPanel extends Panel {
   ...
   public void update(Graphics g) {
      if (ifont != (12*size().width)/230) {
         ifont = (12*size().width)/250;
         setFont(new Font("Helvetica",Font.PLAIN,ifont));
      }
   }
