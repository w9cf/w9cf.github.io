...
\makeatother
{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay60}%
...
$\displaystyle{\frac{R_s}{2 \pi Z_0 b}}$%
\lthtmlinlinemathZ
\hfill\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay62}%
$\displaystyle\left [ 1 + \frac{b}{d_0} \left (
\frac{\partial d_0}{\partial w}
...
{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay64}%
$\displaystyle{\frac{d_0}{
\frac{\partial d_0}{\partial w}
+ \frac{\partial d_0}{\partial t}}}$%
\lthtmlinlinemathZ
\hfill\lthtmlcheckvsize\clearpage}
